...
{
    public class Tutorial_02 : Level
    {
        ...
        protected override void BuildPage()
        {
            ...
            Header.Lines[2].Add(new LineItem(menuController.GetString("You can not pass through the walls") + " \"", centerLine: true));
            Header.Lines[2].Add(new LineItem("[ ]", fgColor: ConsoleColor.Black, bgColor: ConsoleColor.DarkGray));
            Header.Lines[2].Add(new LineItem("\"."));
            Header.Lines[3].Add(new LineItem(menuController.GetString("They are fixed and undestructible") + ".", centerLine: true));
