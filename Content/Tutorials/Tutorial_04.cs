...
{
    public class Tutorial_04 : Level
    {
        ...
        protected override void BuildPage()
        {
            ...
            Header.Lines[2].Add(new LineItem("[", fgColor: ConsoleColor.DarkCyan));
            Header.Lines[2].Add(new LineItem("a", fgColor: ConsoleColor.Cyan));
            Header.Lines[2].Add(new LineItem("]", fgColor: ConsoleColor.DarkCyan));
            Header.Lines[2].Add(new LineItem("\" " + menuController.GetString("is a door that only opens after collecting a specific key") + " \""));
            Header.Lines[2].Add(new LineItem("a", fgColor: ConsoleColor.Cyan));
